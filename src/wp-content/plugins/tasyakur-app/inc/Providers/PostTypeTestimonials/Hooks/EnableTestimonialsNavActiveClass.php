...
class EnableTestimonialsNavActiveClass implements \Tasyakur\Core\Contracts\HooksInterface
{
    ...
    {
        if ( RegisterTestimonialsPostType::POST_TYPE_NAME == get_post_type() && ! is_admin() ) {
            global $wpdb;
            ...
            if( $page && $page->post_name == RegisterTestimonialsPostType::POST_TYPE_NAME ) {
